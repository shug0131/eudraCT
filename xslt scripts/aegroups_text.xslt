...
<xsl:template name="event">
		...
		<organSystem>
			<eutctId><xsl:value-of select ="eutctId"/></eutctId>
			<version>19</version>
		</organSystem>
		<assessmentMethod>
			<value>ADV_EVT_ASSESS_TYPE.non_systematic</value>
...
<xsl:template match="SERIOUS">
	<occurrencesCausallyRelatedToTreatment><xsl:value-of select="occurrencesCausallyRelatedToTreatment"/></occurrencesCausallyRelatedToTreatment>
	<fatalities>
		<deaths><xsl:value-of select="deaths"/></deaths>
		<deathsCausallyRelatedToTreatment><xsl:value-of select="deathsCausallyRelatedToTreatment"/></deathsCausallyRelatedToTreatment>
	</fatalities>
</xsl:template>
...
<xsl:template match="GROUP">
	<reportingGroup  id="{generate-id(title)}">
		...
		<subjectsAffectedByNonSeriousAdverseEvents><xsl:value-of select="subjectsAffectedByNonSeriousAdverseEvents"/></subjectsAffectedByNonSeriousAdverseEvents>
		<subjectsAffectedBySeriousAdverseEvents><xsl:value-of select="subjectsAffectedBySeriousAdverseEvents"/></subjectsAffectedBySeriousAdverseEvents>
		<subjectsExposed><xsl:value-of select="subjectsExposed"/></subjectsExposed>
		<deathsAllCauses><xsl:value-of select="deathsAllCauses"/></deathsAllCauses>
		<deathsResultingFromAdverseEvents><xsl:value-of select="deathsResultingFromAdverseEvents"/></deathsResultingFromAdverseEvents>
	</reportingGroup>
