...
#OUTPUT
setwd(file.path("V:", "STATISTICS", "NON STUDY FOLDER", "Academic Research", "Eudract Tool", "testing", "stata", "output"))
getwd()

#Check the output is created "simple.xml"
input.good="V:/STATISTICS/NON STUDY FOLDER/Academic Research/Eudract Tool/testing/stata/output/simple.xml"
input.bad="V:/STATISTICS/NON STUDY FOLDER/Academic Research/Eudract Tool/testing/stata/output/"
