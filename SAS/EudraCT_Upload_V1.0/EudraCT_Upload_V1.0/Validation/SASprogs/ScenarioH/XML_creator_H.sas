...
%let dir=P:\CTRU\Stats\Programming\SAS\Eudract\Validation;
...
libname m "&dir.\SASdata\ScenarioH";
...
/*Specify output file*/
%let file=&dir.\output\ScenarioH\EudractUpload.xml;
...
dm 'output; file "&dir.\SASout\ScenarioH\&progname..lst" replace;';                   
dm 'log; file "&dir.\SASlog\ScenarioH\&progname..log" replace;'; 
