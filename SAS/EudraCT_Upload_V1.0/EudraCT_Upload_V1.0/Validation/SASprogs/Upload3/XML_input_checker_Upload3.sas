...
%let dir=P:\CTRU\Stats\Programming\SAS\Eudract\Validation\SASdata\Upload3;

**--------------------------------------------------------------------------------;
**||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||;
**--------------------------------------------------------------------------------;
**                                                                                ;
**Filename..........XML_input_checker_Upload3	                                  ;
**                                                                                ;
**Date created......09/02/2017                                                    ;
**                                                                                ;
**Last amended......13/07/2017 (To run with correct dummy data)                   ;
**                                                                                ;
**Trial.............NA                                                            ;
**                                                                                ;
**Analysis..........NA                					                          ;
...
libname library "P:\CTRU\Stats\Programming\SAS\Eudract\Validation\SASformats";
...
/* checks to see if SOC matches correctly */
data _null_;
	set EudractSAE;
