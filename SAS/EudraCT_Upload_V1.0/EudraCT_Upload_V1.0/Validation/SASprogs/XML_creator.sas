...
___________________________________________________________________________
	...
	Output files			:   results_with_ae.xml
...
/*Specify output file*/
%let file=&dir.EudractUpload.xml;
...
data _null_;
	...
	if first.term then
		do;
			...
			else put '                    <value>ADV_EVT_ASSESS_TYPE.systematic</value>';
			put '                </assessmentMethod>';
...
dm 'output; file "&dir.&progname..lst" replace;';                   
dm 'log; file "&dir.&progname..log" replace;'; 
